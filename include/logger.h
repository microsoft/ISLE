...
namespace ISLE {
  ...
  class Logger {
   ...
   public:
    ...
    void log_info(const std::string& msg, const std::string& fileName,
                  const std::string& fnName, int lineNo);
    void log_trace(const std::string& msg, const std::string& fileName,
                   const std::string& fnName, int lineNo);
    void log_warning(const std::string& msg, const std::string& fileName,
                     const std::string& fnName, int lineNo);
    void log_error(const std::string& msg, const std::string& fileName,
                   const std::string& fnName, int lineNo);

    void log_timer(const std::string& msg, const std::string& fileName,
                   const std::string& fnName, int lineNo);

    void log_diagnostic(const std::string& msg, const std::string& fileName,
                        const std::string& fnName, int lineNo);
    void log_diagnostic(const int& num, const std::string& num_name,
                        const std::string& fileName, int lineNo);

    void set_trace_func(ChannelFunc func_) {
      trace_print_func = func_;
    }
    void set_info_func(ChannelFunc func_) {
      info_print_func = func_;
    }
    void set_warning_func(ChannelFunc func_) {
      warning_print_func = func_;
    }
    void set_error_func(ChannelFunc func_) {
      error_print_func = func_;
    }
...
#define LOG_DIAGNOSTIC_MSG(msg) \
  global_log_diagnostic(msg, __FILE__, __func__, __LINE__)
...
#define LOG_SET_ERROR_FUNC(func_) global_set_error_func(func_)
  ...
  void global_log_info(const std::string& msg, const std::string& fileName,
                       const std::string& fnName, int lineNo);
  void global_log_trace(const std::string& msg, const std::string& fileName,
                        const std::string& fnName, int lineNo);
  void global_log_warning(const std::string& msg, const std::string& fileName,
                          const std::string& fnName, int lineNo);
  void global_log_error(const std::string& msg, const std::string& fileName,
                        const std::string& fnName, int lineNo);

  void global_log_timer(const std::string& msg, const std::string& fileName,
                        const std::string& fnName, int lineNo);
  bool global_open_timer_log_file(const std::string& outDir);

  void global_log_diagnostic(const std::string& msg,
                             const std::string& fileName,
                             const std::string& fnName, int lineNo);
  void global_log_diagnostic(const int& num, const std::string& num_name,
                             const std::string& fileName, int lineNo);
