...
//try { // NIPS
//	word_id_t	vocab_size = 5002;
//	doc_id_t	num_docs = 1491;
//	offset_t	max_entries = 639743;
//	doc_id_t	num_topics = 15;
...
//}
//try { // Cosomos
//	word_id_t	vocab_size = 1058546;
//	doc_id_t	num_docs = 4026;
...
//}
//try { // Enron
//	word_id_t	vocab_size = 5003;
//	doc_id_t	num_docs = 29823;
//	offset_t	max_entries = 2722177;
//	doc_id_t	num_topics = 20;
//	ISLE::ISLETrainer trainer(vocab_size, num_docs, max_entries, num_topics,
...
//}
//    try { // nytimes 30k
//        word_id_t	vocab_size = 5000;
//        doc_id_t	num_docs = 30000;
//        offset_t	max_entries = 4886003;
//        doc_id_t	num_topics = 50;
//        ISLE::ISLETrainer trainer(vocab_size, num_docs, max_entries, num_topics,
//            false, -1.0, ISLE::ISLETrainer::data_ingest::FILE_DATA_LOAD,
//#if defined(_MSC_VER)
...
//    }
/*try { // NYTimes ~300K
word_id_t	vocab_size = 5004;
doc_id_t	num_docs = 296784;
offset_t	max_entries = 47978132;
doc_id_t	num_topics = 100;
ISLE::ISLETrainer trainer(vocab_size, num_docs, max_entries, num_topics,
...
//}
//try { // Bing Ads small
//	word_id_t	vocab_size = 10000;
//	doc_id_t	num_docs = 1000000;
...
//}
//    try { // Pubmed New
//        word_id_t	vocab_size = 140577;
//        doc_id_t	num_docs = 8150000;
//        offset_t	max_entries = 428645007;
//        doc_id_t	num_topics = 10;
//        ISLE::ISLETrainer trainer(vocab_size, num_docs, max_entries, num_topics,
//            false, 1.0, ISLE::ISLETrainer::data_ingest::FILE_DATA_LOAD,
//#if defined(_MSC_VER)
...
//	word_id_t	vocab_size = 999910;
//	doc_id_t	num_docs = 1001466;
...
//	word_id_t	vocab_size = 200000;
//	doc_id_t	num_docs = 11702401;
...
//	word_id_t	vocab_size = 101504;
//	doc_id_t	num_docs = 269714;
...
//try { // DSA UK Travel
//    word_id_t       vocab_size = 1562308;
//    doc_id_t        num_docs = 22083141;
