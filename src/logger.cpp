...
ISLE::Logger::Logger(std::string fnName)
    : trace_print_func(NULL), info_print_func(NULL), warning_print_func(NULL),
      error_print_func(NULL), isTimerFileOpen(false),
...
void ISLE::Logger::log_info(const std::string& msg, const std::string& fileName,
...
void ISLE::Logger::log_trace(const std::string& msg,
...
void ISLE::Logger::log_warning(const std::string& msg,
                               const std::string& fileName,
                               const std::string& fnName, int lineNo) {
  std::string warning_string = "\n********* WARNING *********\n" + fileName +
                               "(" + fnName + ":" + std::to_string(lineNo) +
                               "): " + msg + "\n***************************\n";
...
void ISLE::Logger::log_error(const std::string& msg,
                             const std::string& fileName,
                             const std::string& fnName, int lineNo) {
...
void ISLE::Logger::log_timer(const std::string& msg,
                             const std::string& fileName,
                             const std::string& fnName, int lineNo) {
  if (isTimerFileOpen)
...
void ISLE::Logger::log_diagnostic(const std::string& msg,
                                  const std::string& fileName,
                                  const std::string& fnName, int lineNo) {
#ifdef LOGGER
  std::string str;
...
void ISLE::Logger::log_diagnostic(const int& num, const std::string& numName,
                                  const std::string& fnName, int lineNo) {
#ifdef LOGGER
  std::string str;
  for (int i = 0; i < level_; ++i)
...
void ISLE::global_log_info(const std::string& msg, const std::string& fileName,
                           const std::string& fnName, int lineNo) {
  GlobalLogger.log_info(msg, fileName, fnName, lineNo);
}

void ISLE::global_log_trace(const std::string& msg, const std::string& fileName,
                            const std::string& fnName, int lineNo) {
  GlobalLogger.log_trace(msg, fileName, fnName, lineNo);
}

void ISLE::global_log_warning(const std::string& msg,
                              const std::string& fileName,
                              const std::string& fnName, int lineNo) {
  GlobalLogger.log_warning(msg, fileName, fnName, lineNo);
}

void ISLE::global_log_error(const std::string& msg, const std::string& fileName,
                            const std::string& fnName, int lineNo) {
  GlobalLogger.log_error(msg, fileName, fnName, lineNo);
}

void ISLE::global_log_timer(const std::string& msg, const std::string& fileName,
                            const std::string& fnName, int lineNo) {
...
void ISLE::global_log_diagnostic(const std::string& msg,
                                 const std::string& fileName,
                                 const std::string& fnName, int lineNo) {
  GlobalLogger.log_diagnostic(msg, fileName, fnName, lineNo);
}

void ISLE::global_log_diagnostic(const int& num, const std::string& numName,
                                 const std::string& fnName, int lineNo) {
